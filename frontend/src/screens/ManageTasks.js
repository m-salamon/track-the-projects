              ...
              <div className="form-row">
                <div className="form-group col-md-6">
                  ...
                  <div className="input-group billByTaskInput">
                    ...
                    <input name="hourlyRate" value={this.state.inputs.hourlyRate} onChange={this.changeHandler} className="form-control" style={{ border: '1px solid rgb(255, 255, 255)' }} placeholder="task hourly rate" type="number" />
                  </div>
                </div>
              </div>
