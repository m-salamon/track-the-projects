...
import { addClient, getClient , deleteClient } from '../actions/actions';
...
class ManageItems extends React.Component{
    ...
    render() {
        ...
        return (
        <div>
            {this.state.modal && <ModalComponent isOpen={this.state.modal} items={this.props.items} ></ModalComponent> }
